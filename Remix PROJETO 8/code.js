...
var line1 = createSprite(200,50,375,3);
line1.shapeColor = "white"

var line2 = createSprite(200,350,375,3);
 ...
 if (keyDown("space")) {
  ...
  // Pontuação
     ...
     if(striker.isTouching(goal1))
      ...
      if(playerScore===5||compScore===5)//adicione a condição para verificar se a pontuação do jogador chegou a 5
